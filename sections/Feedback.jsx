...
const Feedback = () => (
  ...
  <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{once: 'flase', amount: 0.25}} className={`${styles.innerWidth} mx-auto flex lg:flex-row flex-col gap-6`}>
    <motion.div variants={fadeIn("right", "tween", 0.2, 1)} className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative">
      ...
      <p className="mt-[8px] font-normal sm:text-[18px] text-[12px] sm:leading-[45px] leading-[39px] text-white">
        "Rabah Bouchemat, Web developer founder & ceo of CodeIt, Marketing team member in worth club"
      </p>
